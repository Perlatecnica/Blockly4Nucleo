...
#   nucleo_compressed.js: The compressed Nucleo generator.
...
class Gen_compressed(threading.Thread):
  ...
  def gen_generator(self, language):
    ...
    params.append(("js_code", "goog.provide('Blockly.Generator');goog.provide('Blockly.StaticTyping');"))
    filenames = glob.glob(
    ...
    remove = "var Blockly={Generator:{},StaticTyping:{}};"
    self.do_compile(params, target_filename, filenames, remove)
